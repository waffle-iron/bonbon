defmodule Bonbon.Cuisine.RegionalVariant.Province.TranslationTest do
    use Bonbon.ModelCase

    alias Bonbon.Cuisine.RegionalVariant.Province.Translation

    @pkey :cuisine_regional_variant_province_translations_pkey
