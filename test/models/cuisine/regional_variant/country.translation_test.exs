defmodule Bonbon.Cuisine.RegionalVariant.Country.TranslationTest do
    use Bonbon.ModelCase

    alias Bonbon.Cuisine.RegionalVariant.Country.Translation

    @pkey :cuisine_regional_variant_country_translations_pkey
