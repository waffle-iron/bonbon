defmodule Bonbon.Cuisine.RegionalVariant.Continent.TranslationTest do
    use Bonbon.ModelCase

    alias Bonbon.Cuisine.RegionalVariant.Continent.Translation

    @pkey :cuisine_regional_variant_continent_translations_pkey
